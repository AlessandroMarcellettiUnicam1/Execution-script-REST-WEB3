...
async function invokeContractFunction(contractInfoPath, functionName, params, role) {
    ...
    }else if(role === "producer" || role === "2ND_LEVEL_SUPPORT_AGENT"){
        //PATIENT ADDRESS
        fromAddress = "0x62AbA4475128080Dd4B59FA5D7E2fAEb2B720A21";
    }else if(role == "retailer" || role == "VIP_CUSTOMER"){
        //RADIOLOGY address
        fromAddress = "0xc58A17120480496809797520150f4aA43c24Fd43";
    }else if(role == "customer" || role == "SOFTWARE_DEVELOPER"){
        //WARD address
    ...
    }else if(role == "1ST_LEVEL_SUPPORT_AGENT"){
   ...
   /*if(functionName == "setIPFSLink"){
    ...
    }if(role === "producer" || role === "2ND_LEVEL_SUPPORT_AGENT"){
